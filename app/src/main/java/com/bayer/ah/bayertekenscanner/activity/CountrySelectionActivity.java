...
import com.bayer.ah.bayertekenscanner.fragment.teekMelden.CountrySelectionFragment;
...
public class CountrySelectionActivity extends ToolbarActivity {
    ...
    protected Fragment getFragment() {
        return CountrySelectionFragment.newInstance(getIntent().getBundleExtra(EXTRA_PET_BUNDLE));
    }
